export default class Tower {
    ...
    public towerTop :any
    constructor(scene : any, type : string, position : Array<number>, scale : number) {
        // tower base
        ...
        scene.appendChild(this.towerBase)
        // tower body
        ...
        scene.appendChild(this.towerBody)
        // tower top
        ...
        scene.appendChild(this.towerTop)
